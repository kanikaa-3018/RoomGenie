    ...
    <div className="space-y-6">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-green-800">Complaints System Active</h3>
            <p className="text-sm text-green-700 mt-1">
              The complaints management system is now fully integrated with the backend API. 
              You can view, update status, and manage all resident complaints from this interface.
            </p>
          </div>
        </div>
      </div>
